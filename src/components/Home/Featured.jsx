...
const Featured = () => {
    return (
        <div className="featured-item bg-fixed text-white pt-8 my-20">
            ...
            <p className='text-2xl font-bold mx-auto'>Sub Title</p>
            <p className='py-5'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cumque aliquam quia aspernatur?</p>
            </div>
